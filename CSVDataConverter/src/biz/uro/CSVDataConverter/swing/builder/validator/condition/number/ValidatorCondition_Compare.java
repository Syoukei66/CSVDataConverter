...
public abstract class ValidatorCondition_Compare extends ValidatorCondition_Value {
	...
	public ValidatorCondition_Compare( JSONReader reader ) {
		super( reader );
		mGreater = reader.get( GREATER ).asBoolean();
	}

	public ValidatorCondition_Compare( boolean greater ) {
		mGreater = greater;
	}
	...
	@JSONClassID( "Number_Compare" )
	public static final class _Number extends ValidatorCondition_Compare {
	...
	@JSONClassID( "String_Compare" )
	public static final class _String extends ValidatorCondition_Compare {
